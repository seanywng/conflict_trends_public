...
protest_network_graph_indonesia <- acled_protests |>
  ...
  geom_node_text(aes(label = ifelse(name %in% 
                                        c("myanmar", "laundering", "coronavirus",
                                          "citizenship", "wage", "load", "farm", 
                                          "prices", "arrears", "palestine", "kashmir", 
                                          "pension", "fukushima", "majeste",
                                          "arrested", "oli", "manipur", "korea", "rights", 
                 ...
                 colour = "#e63946", 
                 face = "bold") + 
  geom_node_text(aes(label = name), size = 2.6, alpha = .4, 
                 colour = "#caf0f8") + 
  theme(legend.position = "none", 
...
ggsave(here("plots", "protest_network_graph_indonesia_new.png"), 
